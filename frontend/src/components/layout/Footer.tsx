...
export default function Footer(props: FooterProps) {
  return (
    <footer className="bg-[var(--primary-color)]">
      <div className="max-w-7xl mx-auto px-3 py-8 grid grid-cols-[auto_1fr_auto] items-center">
        ...
        <div className="flex items-center gap-8">
          ...
          <div className="flex items-center gap-2">
            <p className="text-xs font-bold text-[var(--dark-text)]">Instagram</p>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="text-[var(--dark-text)] hover:text-[var(--orange-color)] transition-colors">
          ...
          {/* Facebook */}
          <div className="flex items-center gap-2">
            <p className="text-xs font-bold text-[var(--dark-text)]">Facebook</p>
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="text-[var(--dark-text)] hover:text-[var(--orange-color)] transition-colors">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
